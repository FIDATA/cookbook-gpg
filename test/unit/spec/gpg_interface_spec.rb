...
describe BswTech::Gpg::GpgInterface do
  ...
  it 'can check current keys while suppressing the trust db check' do
    ...
    expect(@gpg_command_executed).to eq('gpg --batch --no-tty --no-auto-check-trustdb --list-secret-keys --with-fingerprint --with-colons')
  end
  ...
  it 'fetches current secret keys' do
    ...
    # assert
    expect(result).to eq(key_headers)
    expect(@gpg_command_executed).to eq('gpg --batch --no-tty --list-secret-keys --with-fingerprint --with-colons')
  end
  ...
  it 'fetches current public keys' do
    ...
    # assert
    expect(result).to eq(key_headers)
    expect(@gpg_command_executed).to eq('gpg --batch --no-tty --list-keys --with-fingerprint --with-colons')
  end
  ...
  it 'fetches current secret keys from a non default ring' do
    ...
    # assert
    expect(result).to eq(key_headers)
    expect(@gpg_command_executed).to eq('gpg --batch --no-tty --no-default-keyring --keyring stuff_public.gpg --secret-keyring stuff_secret.gpg --list-secret-keys --with-fingerprint --with-colons')
  end
  ...
  it 'fetches current public keys from a non default ring' do
    ...
    # assert
    expect(result).to eq(key_headers)
    expect(@gpg_command_executed).to eq('gpg --batch --no-tty --no-default-keyring --keyring stuff_public.gpg --secret-keyring stuff_secret.gpg --list-keys --with-fingerprint --with-colons')
  end
  ...
  it 'imports keys properly into a default keyring' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --import'
    expect(@gpg_input_supplied).to eq @dummy_secret_key_base64
  end
  ...
  it 'imports keys while suppressing the trustdb check' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --no-auto-check-trustdb --import'
    expect(@gpg_input_supplied).to eq @dummy_secret_key_base64
  end
  ...
  it 'imports keys into a non-default keyring' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --no-default-keyring --keyring stuff_public.gpg --secret-keyring stuff_secret.gpg --import'
    expect(@gpg_input_supplied).to eq @dummy_secret_key_base64
  end
  ...
  it 'imports trust properly with a default keyring' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --import-ownertrust'
  ...
  it 'imports trust properly with a non-default keyring' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --no-default-keyring --keyring stuff_public.gpg --secret-keyring stuff_secret.gpg --import-ownertrust'
    expect(@gpg_input_supplied).to eq "fp:6:\n"
  end
  ...
  it 'imports trust while suppressing the trustdb check' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --no-auto-check-trustdb --no-default-keyring --keyring stuff_public.gpg --secret-keyring stuff_secret.gpg --import-ownertrust'
    expect(@gpg_input_supplied).to eq "fp:6:\n"
  end
  ...
  it 'deletes keys properly' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --delete-secret-and-public-key --batch --yes fp'
  end
  ...
  it 'deletes while suppressing the trustdb check' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --no-auto-check-trustdb --delete-secret-and-public-key --batch --yes fp'
  end
  ...
  it 'deletes keys properly with a non-default keyring' do
    ...
    # assert
    expect(@gpg_command_executed).to eq 'gpg --batch --no-tty --no-default-keyring --keyring stuff_public.gpg --secret-keyring stuff_secret.gpg --delete-secret-and-public-key --batch --yes fp'
  end
  ...
  it 'lets me provide a custom command runner' do
    ...
    allow(runner).to receive(:run) do |cmd, user|
      got_call = true if cmd == 'gpg --batch --no-tty --no-default-keyring --keyring stuff_public.gpg --secret-keyring stuff_secret.gpg --delete-secret-and-public-key --batch --yes fp' && user == 'some_user'
    end
